...
#### 🍌 New Feature: BananaVision - Conversational Image Generation for ComfyUI 🍌
- We've added a brand new conversational interface for image generation! BananaVision lets you iterate on images naturally through chat, rather than just one-off prompts.
